...
<c:if test="${empty currentClient.last_name && empty currentClient.last_name}">
    <div class="w3-padding-64 w3-light-grey w3-small w3-center">
        <div class="w3-row-padding">
            ...
            <p></p>
            <form:form id="inscriptionClient" method="POST" action="/firstSpring/connectionClient/send"
                ...
                <p>
                    <form:input class="w3-input w3-border" type="password" path="password" name="Password"
                                placeholder="password"></form:input>
                    <form:errors path="password"></form:errors>
                </p>
                <p></p>
                <form:button type="submit" class="w3-button w3-block w3-black"><spring:message
                        code="send"/></form:button>
            </form:form>
        </div>
        <p>
                ...
                <div class="well well-sm">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-8">
                            ...
                            <small>${currentClient.street_name}
                                n°${currentClient.number_address}, ${currentClient.zip} ${currentClient.city}, ${currentClient.country}
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="/firstSpring/cart/buyCommand"><spring:message code="historyOrder"/></a>
                                    </li>
