...
<h2><spring:message code="product"/></h2>
    ...
    <div class="row">
        ...
        <div class="col-xs-5" style="border:0px solid gray">
            ...
            <h5 style="color:#337ab7">By<a href="http://www.galaxie-carrelages.com/">Galaxie</a> · <small style="color:#337ab7">(${articleDetail.quantityStock} restant)</small></h5>

            <!-- Precios -->
            <h6 class="title-price"><small><spring:message code="price"/></small></h6>
            ...
            <div class="section" style="padding-bottom:20px;">
                <h6 class="title-attr"><small><spring:message code="quantity"/></small></h6>
                <div>
            ...
            <div class="section" style="padding-bottom:20px;">
                <a href="javascript:var qty = document.getElementById('qty').value; window.location = '/firstSpring/cart/add/${articleDetail.id}/'+qty">
                    <button class="btn btn-success"><span style="margin-right:20px" class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span><spring:message code="addCart"/></button>
                </a>
