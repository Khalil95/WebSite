...
<table id="cart" class="table table-hover table-condensed">
    ...
    <tr>
        <td><a href="/firstSpring/home" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue Shopping</a>
        </td>
        <td colspan="2" class="hidden-xs"></td>
        <td class="hidden-xs text-center"><strong>Total : ${priceTotal}$</strong></td>
        <td><a href="/firstSpring/cart/checkout" class="btn btn-success btn-block">Checkout <i
